            ...
            for attempt in range(max_retries):
                try:
                    ...
                    if "429" in error_str or "RESOURCE_EXHAUSTED" in error_str:
                        yield f"\nอูยยยย... ตอนนี้คนทักเข้ามาปรึกษาเยอะมากเลยครับ ระบบผมเลยประมวลผลไม่ทันชั่วคราว (โควตา API เต็ม) รบกวนคุณน้องรอสัก 1-2 นาทีแล้วพิมพ์ถามใหม่อีกรอบนะครับ 🙏 หรือโทร 02-727-3000 ได้เลยครับ!\n\n"
                    else:
                        short_err = error_str.split("{")[0][:100].strip()
                        yield f"\nอูยยยย... ตอนนี้คนทักเข้ามาปรึกษาเยอะมากเลยครับ ระบบผมเลยประมวลผลไม่ทันชั่วคราว รบกวนคุณน้องพิมพ์ถามใหม่อีกรอบนะครับ 🙏 หรือโทร 02-727-3000 ได้เลยครับ! (รหัส: {short_err})\n\n"
                    break
        else:
